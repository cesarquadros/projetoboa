...
<body ng-app="app" ng-controller="appCtrl">
	...
	<div class="container">
		...
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="http://www.creative-tim.com">BOA
				...
				<div class="modal-body">
					...
					<form action="/cadastrar" method="POST">
							...
							<div class="col-xs-12 col-sm-12 col-md-12">
								<div class="form-group label-floating" id="divNome">
									<label class="control-label">Nome Completo</label> <input
										type="text" class="form-control" ng-model="nome"
										ng-blur="insereIcone = teste(nome)"> <span
										class="form-control-feedback" ng-if="insereIcone"> <i
										class="material-icons">done</i>
									</span> <span class="material-icons form-control-feedback"
										ng-if="insereIcone == false">clear</span>
								</div>
							</div>
						</div>
						<div class="row">
							...
							<div class="col-xs-12 col-sm-12 col-md-6">
								<div class="form-group label-floating has-success">
									<label class="control-label">Confirmar Email</label> <input
						...
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-6">
								<div class="form-group label-floating has-error">
									<label class="control-label">Telefone Celular</label> <input type="text"
										class="form-control" />
								</div>
							</div>
							<div class="col-xs-12 col-sm-12 col-md-6">
	...
	<div class="wrapper">
		<div class="header header-filter"
			style="background-image: url('resources/img/examples/city.jpg'); min-height: 200px"></div>
						...
						<div id="menu1" class="tab-pane fade" ng-if="usuarioLogado">
							...
							<div class="row">
								<div class="col-xs-12 col-sm-12 col-md-3">
									...
									<h4>
										<a href="#" class="btn btn-primary" ng-click="setSala('1')"
											ng-model="data" value="1">Sala 1</a> <a href="#"
											class="btn btn-primary" ng-click="setSala('2')">Sala 2</a>
									</h4>
									<h4>
										<a href="#" class="btn btn-primary">Sala 3</a> <a href="#"
											class="btn btn-primary">Sala 4</a>
									</h4>
									<h4>
										<a href="#" class="btn btn-primary">Sala 5</a> <a href="#"
											class="btn btn-primary">Sala 6</a>
									</h4>
								...
								<div class="col-xs-12 col-sm-12 col-md-4">
									...
									<input id="data" class="datepicker form-control" type="text"
										value="${dataAtual}" /> <a href="#"
										class="btn btn-primary btn-sm" style="float: right;"
										ng-click="testeBusca()"> Buscar</a>
								</div>

		...
		<div class="container">
	    	...
	    	<a href="/">
	        	<div class="logo-container">
	                <div class="logo">
	                    <img style="width:10%;" src="./resources/img/boa/logo_boa_branco.png" alt="Creative Tim Logo" rel="tooltip" 
	                    title="<b>Material Kit</b> was Designed & Coded with care by the staff from <b>Creative Tim</b>" data-placement="bottom" data-html="true">
	                </div>
